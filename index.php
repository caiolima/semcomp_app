...
<body>
	...
	<div class="well well-small marge_15" align="center">
		...
		<div class="row-fluid">
			<div class="span6">
				<a href="show_eventos.php?action=categoria&idcategoria=2"><img width="100px" height="100px" src="img/dia_1.png" class="img-rounded"></a>
			</div>
			<div class="span6">
				<a href="show_eventos.php?action=categoria&idcategoria=3"><img width="100px" height="100px" src="img/dia_2.png" class="img-rounded"></a>
			</div>
		</div>
		<div class="row-fluid" style="margin-top: 20px">
			<div class="span6">
				<a href="show_eventos.php?action=categoria&idcategoria=4"><img width="100px" height="100px" src="img/dia_3.png" class="img-rounded"></a>
			</div>
			<div class="span6">
				<a href="show_eventos.php?action=categoria&idcategoria=5"><img width="100px" height="100px" src="img/dia_4.png" class="img-rounded"></a>
			</div>
		</div>
	</div>
